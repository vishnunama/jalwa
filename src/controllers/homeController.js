...
const worldNumberOnedPagePage = async (req, res) => {
  return res.render("checkIn/world_no_1.ejs");
};
const wingoOneMinPagePage = async (req, res) => {
  return res.render("checkIn/wingo_1min.ejs");
};
const slotGamesPagePage = async (req, res) => {
  return res.render("checkIn/slots_game.ejs");
};
const partnerRewarPagePage = async (req, res) => {
  return res.render("checkIn/partner_reward.ejs");
};
const hundredKPagePage = async (req, res) => {
...
const rsPayWithdrawalPage = async (req, res) => {
  let auth = req.cookies.auth;
  const [user] = await connection.query(
    "SELECT * FROM users WHERE `token` = ? ",
    [auth],
...
const rsPayWithdrawalHistoryPage = async (req, res) => {
  let auth = req.cookies.auth;
  const [user] = await connection.query(
    "SELECT * FROM users WHERE `token` = ? ",
    [auth],
