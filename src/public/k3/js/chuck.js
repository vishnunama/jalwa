...
function callListOrder() {
  $.ajax({
    ...
    success: function (response) {
      ...
      $(".slot-transform:eq(0) .slot-num").attr(
        "class",
        `slot-num bg${result[0]}`,
      );
      $(".slot-transform:eq(1) .slot-num").attr(
        "class",
        `slot-num bg${result[1]}`,
      );
      $(".slot-transform:eq(2) .slot-num").attr(
        "class",
        `slot-num bg${result[2]}`,
      );
    },
  });
}
