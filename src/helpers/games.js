...
//       url: `https://bigdaddy.igtechgaming.com/api/v1/wingo/type/${mappedTypeId}`,
//       headers: {},
...
//     if (!issueNumber) {
//       console.warn('No issue number found in response');
//       return null;
//     }
...
//       method: 'get',
//       maxBodyLength: Infinity,
//       url: `https://bigdaddy.igtechgaming.com/api/v1/wingoresult/type/${mappedTypeId}`,
//       headers: {},
//       timeout: 5000 // 5 second timeout
//     };
...
//     const issueResult = data.data.list[0]?.number || 0;
//     if (!issueResult) {
//       console.warn('No issue number found in response');
//       return null;
//     }
